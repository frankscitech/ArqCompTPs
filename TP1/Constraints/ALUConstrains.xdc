...
#set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports o_led[0]]
...
#set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { o_leds[3] }]; #IO_L23N_T3_35 Sch=led3_r
...
##USB-UART Interface
#set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports o_serial_tx]
#set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports i_serial_rx]
...
#set_property KEEP_HIERARCHY YES [get_cells i_sm_debug_rx]
#set_property KEEP_HIERARCHY YES [get_cells i_sm_debug_tx]
#set_property DONT_TOUCH YES [get_cells i_sm_debug_rx]
#set_property DONT_TOUCH YES [get_cells i_sm_debug_tx]
